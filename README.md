...
| **What it does** | Cited, schema-validated answers over an engineering corpus — **abstains instead of guessing** | Bounded multi-tool agent with hard budgets, 5 stop conditions, and a per-step audit trail | Validates messy multi-source exports into an AI-ready store with a per-run quality score |
...
| `ENGINEERING_REVIEW.md` | Senior-engineer review: root causes, duplicate-logic verdicts, perf findings — FIXED / DELIBERATE / DEFERRED |
